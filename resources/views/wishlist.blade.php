                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">  <a href="">Whishlist</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    @if($auth)
        ...
        @else
            <div class="no-results">
                <h1 > Non hai ancora aggiunto alcun titolo </h1>
            </div>
        @endif
    @else
        <div class="no-results">
            <h1 >Effettua il log in per accedere ai tuoi preferiti</h1>
        </div>
