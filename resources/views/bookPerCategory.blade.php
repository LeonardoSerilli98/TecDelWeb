                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">  <a href="/categories"> Categorie </a> </li>

                                <li class="breadcrumb-item active" aria-current="page"><a href="">  {{$cat->categoria}}</a></li>
